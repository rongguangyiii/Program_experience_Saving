...
* 需要链接库：CGAL
* 推荐使用包管理工具VCPKG管理和安装CGAL库，具体步骤参考[VCPKG官网文档](https://learn.microsoft.com/zh-cn/vcpkg/get_started/overview)
* CGAL安装步骤参考[CGAL说明文档](https://doc.cgal.org/latest/Manual/general_intro.html)